...
cmd({
  ...
  try {
    ...
    const _0x13d51a = await fetch("https://kingvon-xmd-piar.onrender.com/pair?phone=" + encodeURIComponent(_0x3b2587));
    const _0x2e869c = await _0x13d51a.json();
    if (_0x2e869c.code) {
      const _0x25f740 = _0x2e869c.code;
      const _0xeea95a = "*⚡Pairing Code For kingvon-xmd 🗿*\n\n🪀 notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your *KINGVON MD* session id.\n\n*🔢 Pairing Code* : *" + _0x25f740 + "*\n\n> *_Copy it from below message 👇🏻_*";
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://i.ibb.co/0p5JWGfj/kingvon-xmd.jpg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    const _0x3a87c7 = await _0x5aa4f0('https://kingvon-xmd-piar.onrender.com/pair?phone=' + _0x4de0bb);
    ...
    await _0x50e2bb("> *KINGVON MD PAIR COMPLETED*\n\n*Your pairing code is:* " + _0x27dff2);
