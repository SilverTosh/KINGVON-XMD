...
cmd({
  ...
  reply("> KINGVON MD ɪs ғᴇᴛᴄʜɪɴɢ ᴀᴜᴅɪᴏ... 🎧");
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("KINGVON MD🇰🇪: sᴘᴏᴛɪғʏ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  } else if (youtubeSent) {
    reply("KINGVON MD: ʏᴏᴜᴛᴜʙᴇ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  }
});
