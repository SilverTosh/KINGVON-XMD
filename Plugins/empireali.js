...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: { url: "https://i.ibb.co/TDF3kZf1/kingvon-xmd.jpg" },
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "25472032631685392165@s.whatsapp.net", // Replace with staff contact numbers
                "25472032631685392165@s.whatsapp.net", // Example: Add staff members here
                "25472032631685392165@s.whatsapp.net", // Example: Add staff members here
                "25472032631685392165@s.whatsapp.net", // Example: Add staff members here
                "25472032631685392165@s.whatsapp.net", // Example: Add staff members here
                "25472032631685392165@s.whatsapp.net", // Example: Add staff members here
