...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/pkdriller/KINGVON MD';

    // Check update status
    let updateMessage = `✅ Your KINGVON MD bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your KINGVON MD bot is outdated!
